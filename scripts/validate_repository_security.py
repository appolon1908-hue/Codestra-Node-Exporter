#!/usr/bin/env python3
"""Validate Codestra Node Exporter protected source authority."""
...
SYNC_WORKFLOW_SHA256 = "392d12dd691106334b87330532a10429dfa8fdd95901d0a14fb1743ea14ffcda"
...
def validate_sync_branch_authority(source: str) -> None:
    expected = 'readonly SYNC_BRANCH="sync/node-exporter-upstream-${UPSTREAM_SHA}-${GITHUB_SHA}"'
...
def validate_upstream(source: dict, lock: dict) -> None:
    expected = {
        ...
        "codestra_repository": "appolon1908-hue/Codestra-Node-Exporter",
        "upstream_repository": "prometheus/node_exporter",
        "upstream_clone_url": "https://github.com/prometheus/node_exporter.git",
...
def validate_sync(source: str, document: dict) -> None:
    ...
    required = (
        ...
        'readonly SYNC_BRANCH="sync/node-exporter-upstream-${UPSTREAM_SHA}-${GITHUB_SHA}"',
...
if __name__ == "__main__":
    try:
        ...
        raise SystemExit(f"NODE_EXPORTER_SOURCE_SECURITY=FAIL ERROR={error}") from error
    print("NODE_EXPORTER_SOURCE_SECURITY=PASS")
