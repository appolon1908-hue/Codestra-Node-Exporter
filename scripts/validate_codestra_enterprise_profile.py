...
if not d.get('hostMetricScope') or not d.get('features'): fail('host metrics/features must be defined')
if d.get('exposure')=='public_native': fail('native service may not be public')
print('Codestra enterprise profile validation PASS: '+os.environ.get('GITHUB_REPOSITORY','node-exporter'))
